...
def write_to_text(gcs_destination_uri, filename):
...
print("hi")
for entry in os.scandir(r"C:\Users\Silvia\Desktop\Data Science\Wellesley_Catalog_Transcription_Project\missing_pdfs"):
    print(entry.name)
    ...
    write_to_text("gs://ocr-test-wdc/transcript_jsons/{}".format(entry.name), "{}.txt".format(entry.name))
